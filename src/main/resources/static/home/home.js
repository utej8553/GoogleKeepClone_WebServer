window.addEventListener("DOMContentLoaded", () => {
    ...
    fetch(`https://googlekeepclone-webserver.onrender.com/api/notes?email=${email}`)
    ...
    if (deletebtn) {
        deletebtn.addEventListener("click", () => {
            ...
            if (confirmDelete) {
                ...
                fetch("https://googlekeepclone-webserver.onrender.com/api/deleteAcc", {
                    method: "POST",
                    headers: {
...
function renderNote(content) {
    ...
    archiveBtn.addEventListener("click", () => {
        const email = localStorage.getItem("email");
        fetch("https://googlekeepclone-webserver.onrender.com/api/archive", {
            method: "POST",
            headers: { "Content-Type": "application/json" },
    ...
    deleteBtn.addEventListener("click", () => {
        const email = localStorage.getItem("email");
        fetch("https://googlekeepclone-webserver.onrender.com/api/trash", {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({ email, content })
        })
